        ...
        <Hero>
          ...
          >
            ...
            >
              ...
              <Box display="flex" alignItems="center" mb="40px" color="#fff">
                <AnchorButton
          ...
          >
            ...
            <Box ml={{ _: '0px', md: '50px', lg: '150px' }} flex="4" mb={{ _: '60px', md: '0' }}>
              ...
              <Paragraph color="slate">
                ...
                enterprise use. UXP runs anywhere and connects to the Upbound Cloud management
                console for real-time visibility and management at scale.
              </Paragraph>
            </Box>
          </Box>
          <Box
          ...
          <Box display="flex" alignItems="center" flexDirection={{ _: 'column', md: 'row' }}>
            <Box mr={{ _: '0px', md: '50px', lg: '150px' }} flex="5">
              ...
              <Paragraph color="slate">
                ...
                operate your business. We’re always happy to discuss your specific needs and demo
                our different hosting options.
              </Paragraph>
              <AnchorButton
                btnType="blackOutline"
        ...
        >
          <Box textAlign="center" mx="30px">
            ...
            <Header variant="h6" color="fillBlackGray">
              Upbounds Universal Cloud Platform scales with your infrastructure whether on premise
        ...
        <Box bgcolor={{ _: COLORS.darkSlateBlue, md: 'transparent' }}>
          <Box px={{ _: '0', md: '30px' }}>
            <QuoteBlock mb={{ _: '0', md: '115px' }}>
              ...
              >
                Upbound automates and simplifies how software developers manage the lifecycle of
                their applications, allowing them to innovate more quickly.
              </Header>
              <Box
                display="flex"
          ...
          >
            <Box mr={{ _: '0', md: '50px' }} textAlign={{ _: 'center', md: 'left' }} mb="60px">
              ...
              <Header variant="h6" color="fillBlackGray" sx={{ mt: '30px' }}>
                ...
                and application management. This empowers team members to deliver value by focusing
            ...
            <Box>
              ...
              >
                ...
                <Paragraph color="fillBlackGray">
                  Speed up development cycles by allowing developers to deploy applications in a
                  more automated and streamlined way. Free up their time to focus on building great
                  apps.
                </Paragraph>
              </TeamQualityTile>
