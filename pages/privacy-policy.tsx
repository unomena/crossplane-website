    ...
    <PageProvider ctaBtnTarget="_blank">
      ...
      >
        ...
        <Paragraph sx={paragraphSpacingLg}>
          ...
          (including www.upbound.io, www.crossplane.io), services, and applications (collectively,
          the "Services"). This Privacy Policy (the "Privacy Policy") does not apply to information
          our customers may process when using our Services.
        </Paragraph>
